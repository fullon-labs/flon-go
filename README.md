...
[![GoDoc](https://godoc.org/github.com/fullon-labs/flon-go?status.svg)](https://godoc.org/github.com/fullon-labs/flon-go)
...
at https://github.com/fullon-labs/flon-go
...
func main() {
	...
	accountResp, _ := api.GetAccount(ctx, "flon")
...
All examples uses by default the `https://m.flonscan.io` API endpoint for all

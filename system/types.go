...
type BlockchainParameters struct {
	MaxBlockNetUsage               flon.Uint64 `json:"max_block_net_usage"`
...
type EOSIOGlobalState struct {
	...
	TotalStorageBytesReserved flon.Uint64 `json:"total_storage_bytes_reserved"`
	TotalStorageStake         flon.Uint64 `json:"total_storage_stake"`
	PaymentPerBlock           flon.Uint64 `json:"payment_per_block"`
}
